...
[xhidecursor](https://github.com/astier/xhidecursor) is a minimal X11 utility that hides the cursor on key presses and shows it again on mouse movement. Modifier keys are ignored. Compared to alternatives such as [xbanish](https://github.com/jcs/xbanish), xhidecursor prioritizes a simple implementation and efficient event processing, resulting in two main advantages:

- **Simplicity:** xhidecursor has only 76 SLOC compared to 488 SLOC for xbanish, as measured by cloc. This is accomplished by using XFixes to hide and show the cursor and XInput2 to handle input events.
